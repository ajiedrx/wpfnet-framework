...
namespace Velacro.UIElements.ProgressBar
{
    ...
    {
        private System.Windows.Controls.ProgressBar myProgressBar_pb;
        private IMyDuration myDuration;
        private IMyDoubleAnimation myDoubleAnimation;
        internal MyProgressBar(object _uiElement) : base((System.Windows.Controls.ProgressBar)_uiElement) {
            myProgressBar_pb = (System.Windows.Controls.ProgressBar)_uiElement;
        }
        ...
        public IMyProgressBar animate(double _duration, double _value) {
            ...
            myProgressBar_pb.BeginAnimation(System.Windows.Controls.ProgressBar.ValueProperty, myDoubleAnimation.getDoubleAnimation());
            return this;
        }
